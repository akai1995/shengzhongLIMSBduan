...
interface StorageAuditSearchFormProps {
...
const categories = ['全部分类', '授权U盘', '部门专盘', '临时使用', '外来设备', '加密U盘']
const statuses = ['全部状态', '在线', '离线', '已拦截', '已禁用']
const departments = ['全部部门', '检验科', '分子诊断室', '微生物室', '质控组', '试剂科', '设备科']

export default function StorageAuditSearchForm({
  searchParams,
  onSearchParamsChange,
  onSearch,
  onReset,
}: StorageAuditSearchFormProps) {
